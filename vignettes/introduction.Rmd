...
* In this example, substitution patterns (6 values, C>A, C>G, C>T, T>A, T>C and T>G), two 5' and 3' flanking bases (4 values for each 4 site, A, C, G and T)
and transcription direction (2 values, + and -) are considered.
...
Here, *inputFile* is the path for the input file. *numBases* is the number of flanking bases to consider (if you want to consider two 5' and 3' bases, then set 5).
