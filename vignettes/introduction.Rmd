...
you can find the example above example file at the directory where pmsignature is installed.

```{r, eval=FALSE}
paste(.libPaths(), "/pmsignature", sep="");
```

For converting your own mutation list data,
we prepared a script which you can find at. 
